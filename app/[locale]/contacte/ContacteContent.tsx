                    ...
                    >
                      ...
                      <form onSubmit={onSubmit} className="space-y-5" noValidate>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <div>
                            <label htmlFor="contact-business" className="block font-mono text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">{t('label_business')}</label>
                            <input id="contact-business" type="text" name="business" value={form.business} onChange={onChange} placeholder={t('placeholder_business')} className={INPUT_CLASS(!!errors.business)} aria-invalid={!!errors.business} />
                            {errors.business && <p className="text-red-400 text-xs mt-1 font-mono">{errors.business}</p>}
                          </div>
                          <div>
                            <label htmlFor="contact-site" className="block font-mono text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">{t('label_site')}</label>
                            <input id="contact-site" type="text" name="site" value={form.site} onChange={onChange} placeholder={t('placeholder_site')} className={INPUT_CLASS(false)} />
                          </div>
                          <div>
                            <label htmlFor="contact-sector" className="block font-mono text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">{t('label_sector')}</label>
                            <input id="contact-sector" type="text" name="sector" value={form.sector} onChange={onChange} placeholder={t('placeholder_sector')} className={INPUT_CLASS(!!errors.sector)} aria-invalid={!!errors.sector} />
                            {errors.sector && <p className="text-red-400 text-xs mt-1 font-mono">{errors.sector}</p>}
                          </div>
                          <div>
                            <label htmlFor="contact-name" className="block font-mono text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">{t('label_name')}</label>
                            <input id="contact-name" type="text" name="name" value={form.name} onChange={onChange} placeholder={t('placeholder_name')} className={INPUT_CLASS(!!errors.name)} aria-invalid={!!errors.name} />
                            {errors.name && <p className="text-red-400 text-xs mt-1 font-mono">{errors.name}</p>}
                          </div>
                          <div>
                            <label htmlFor="contact-email" className="block font-mono text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">{t('label_email')}</label>
                            <input id="contact-email" type="email" name="email" value={form.email} onChange={onChange} placeholder={t('placeholder_email')} className={INPUT_CLASS(!!errors.email)} aria-invalid={!!errors.email} />
                        ...
                        <div>
                          <label htmlFor="contact-message" className="block font-mono text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">{t('label_objective')}</label>
                          <textarea id="contact-message" name="message" value={form.message} onChange={onChange} rows={4} placeholder={t('placeholder_objective')} className={`${INPUT_CLASS(!!errors.message)} resize-none`} aria-invalid={!!errors.message} />

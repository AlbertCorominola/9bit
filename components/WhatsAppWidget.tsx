      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="w-72 overflow-hidden rounded-2xl border border-black/[0.08] bg-surface-container-low/95 backdrop-blur-xl shadow-[0_20px_60px_rgba(13,17,23,0.10)]"
          >
            {/* header */}
            ...
            {/* body */}
            <div className="p-4">
              <div className="rounded-xl rounded-tl-sm bg-black/[0.04] border border-black/[0.08] px-4 py-3 mb-4">
